...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PrivacySettings'
        db.create_table('users_privacysettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'])),
            ('profilefield_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('setting', self.gf('django.db.models.fields.IntegerField')(default='3', max_length=1)),
        ))
        db.send_create_signal('users', ['PrivacySettings'])


    def backwards(self, orm):
        
        # Deleting model 'PrivacySettings'
        db.delete_table('users_privacysettings')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 23, 38, 34, 655109)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 23, 38, 34, 655053)'}),
        ...
        'users.privacysettings': {
            'Meta': {'object_name': 'PrivacySettings'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.UserProfile']"}),
            'profilefield_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'setting': ('django.db.models.fields.IntegerField', [], {'default': "'3'", 'max_length': '1'})
        },
