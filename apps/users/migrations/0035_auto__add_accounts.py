...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_accounts', (
        ...
        db.send_create_signal('users', ['Accounts'])


    def backwards(self, orm):
        
        # Deleting model 'Accounts'
        db.delete_table('users_accounts')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 21, 14, 41, 411656)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 18, 21, 14, 41, 411600)'}),
